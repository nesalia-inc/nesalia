      ...
      <main className="flex flex-col items-center gap-8 px-4 text-center sm:px-6">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="max-w-md text-lg text-zinc-600 dark:text-zinc-400">
            Something amazing is being built. Stay tuned for what's next.
          </p>
        </div>
        ...
        <Link
          ...
          className="group flex items-center gap-2 rounded-full border border-zinc-200 bg-white px-6 py-3 text-sm font-medium text-zinc-900 transition-all hover:border-zinc-300 hover:bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900 dark:text-white dark:hover:border-zinc-700 dark:hover:bg-zinc-800"
        >
          <svg
            className="size-5"
            fill="currentColor"
